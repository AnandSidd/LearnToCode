...
public class Constants {
    ...
    public static final String FLUTTER_CHANNEL_ID = "UCwXdFgeE9KYzlDdR7TG9cMw"; //flutter
    public static final String ADEV_CHANNEL_ID = "UCVHFbqXqoYvEWM1Ddxl0QDg"; //Android dev
    public static final String TF_CHANNEL_ID = "UC0rqucBdTuFTjJiefW5t-IQ"; //TensorFlow
}
