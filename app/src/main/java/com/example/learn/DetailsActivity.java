...
//    private static String GOOGLE_YOUTUBE_API = "AIzaSyC2a003vFPLqX-oIXcsiwfj93b7URlIMcE";
...
//    }
    ...
    /*public void downloadVideo(View view) {
        ...
        YouTubeUriExtractor ytEx = new YouTubeUriExtractor(this) {
            ...
            public void onUrisAvailable(String videoID, String videoTitle, SparseArray<YtFile> ytFiles) {
                if (ytFiles != null) {
                    ...
                    Log.e("download URL :", downloadURL[0]);
                    videoTitle1[0] = videoTitle;
        ...
        new RequestDownloadVideoStream().execute(downloadURL[0], videoTitle1[0]);
    }
